...
var duration = 300,
    ...
    $('ul.tabs li').click(function(){
        ...
        $('ul.tabs li').removeClass('current fadeIn animated');
        $('.tab-content').removeClass('current flipInX animated');

        $(this).addClass('current fadeIn animated');
        $("#"+tab_id).addClass('current flipInX animated');
    });
    // Tabs One inter
    $('ul.tabs_inter li').click(function(){
        var tab_inter_id = $(this).attr('data-tab');

        $('ul.tabs_inter li').removeClass('active fadeIn animated');
        $('.tabs_inter-content').removeClass('active fadeIn animated');

        $(this).addClass('active fadeIn animated');
        $("#"+tab_inter_id).addClass('active fadeIn animated');
    });
});
