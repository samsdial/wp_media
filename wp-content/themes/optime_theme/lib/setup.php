...
function setup() {
  ...
  register_nav_menus([
    ...
    'close_user' => __('Cerrar Sesión', 'sage')
  ]);
  ...
  add_editor_style(Assets\asset_path('styles/style.css'));
}
...
function assets() {
  ...
  /*wp_enqueue_style('clear/css', Assets\asset_path('styles/clear_form.css'), false, null);*/
